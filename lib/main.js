...
function doHighlight() {
  console.log(_("log_highlight", gId, spref.prefs["style"]));

  let contentScript = tabs.activeTab.attach({
  ...
  contentScript.port.on("toggle_off", function(reason) {
  /*
   ...
   */
    ...
    console.log(_("log_toggleoff", logToggleOffReason));
    button.state("tab", {"icon" : gIconOff, "checked" : false});
  });
}

function undoHighlight() {
  console.log(_("log_undo"));
